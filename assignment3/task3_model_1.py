...
class ConvModel1_nobatch(nn.Module):
...
if __name__ == "__main__":
    ...
    utils.plot_loss(trainer2.train_history["loss"], label="Training loss with no batch normalization", npoints_to_average=10)
    utils.plot_loss(trainer2.validation_history["loss"], label="Validation loss with no batch normalization")
    ...
    utils.plot_loss(trainer2.validation_history["accuracy"], label="Validation Accuracy with no batch normalization")
    utils.plot_loss(trainer2.train_history["accuracy"], label="Training Accuracy with no batch normalization")

    plt.legend()
    plt.savefig(plot_path.joinpath(f"model1_comp_plot.png"))
    plt.show()